...
func (_m *IEtherman) BuildTrustedVerifyBatchesTxData(lastVerifiedBatch uint64, newVerifiedBatch uint64, proof tx.ZKP, rollupId uint32) ([]byte, error) {
...
func (_m *IEtherman) CallContract(ctx context.Context, call ethereum.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (_m *IEtherman) GetSequencerAddr(rollupId uint32) (common.Address, error) {
